            ...
            <div className="relative z-10 max-w-2xl ml-auto">
              ...
              <div className="space-y-16">
                <div className="bg-black/80 backdrop-blur-sm rounded-lg p-8">
                  <h3 className="text-2xl mb-4">AI-Powered Smart Contract Analysis</h3>
                ...
                <div className="bg-black/80 backdrop-blur-sm rounded-lg p-8">
                  <h3 className="text-2xl mb-4">Visualizing Blockchain Data</h3>
                  <p className="text-gray-400 mb-4">
                ...
                <div className="bg-black/80 backdrop-blur-sm rounded-lg p-8">
                  <h3 className="text-2xl mb-4">Making Blockchain Intelligence Accessible</h3>
                  <p className="text-gray-400 mb-4">
