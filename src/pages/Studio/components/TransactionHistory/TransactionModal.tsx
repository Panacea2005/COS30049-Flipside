...
export const TransactionModal = ({
  ...
  const formatValue = (value: string) =>
    Number(value).toExponential(5).replace("e", "E");
  ...
  // Function to determine if input data represents a contract interaction
  const isContractInteraction = (input: string) => {
    return input && input !== "0x" && input.length > 10;
  };
        ...
        <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto p-0 rounded-xl">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 border-b">
            <div className="flex flex-col items-center justify-center">
              <Badge
                className={`mb-2 px-3 py-1 ${getStatusColor(
                  transactionStatus
                )}`}
              >
          ...
          >
            ...
            <TabsContent
              value="overview"
              className="p-6 space-y-6 focus-visible:outline-none focus-visible:ring-0"
            >
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        copyToClipboard(transaction.fromAddress, "from")
                      }
                    >
                      {copiedField === "from" ? (
                        <span className="flex items-center text-green-600">
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <Button
                      ...
                      className="h-6 px-2 text-xs"
                      onClick={() =>
                        copyToClipboard(transaction.toAddress, "to")
                      }
                    >
                      {copiedField === "to" ? (
                        <span className="flex items-center text-green-600">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  className="h-8 px-3"
                  onClick={() =>
                    copyToClipboard(transaction.input || "0x", "input")
                  }
                >
                  {copiedField === "input" ? (
                    <span className="flex items-center text-green-600">
              ...
              {/* Show the full input data */}
              <div className="mt-4 space-y-3">
                <div className="text-sm text-gray-600">
                  <strong>Input Data:</strong>
                </div>
                <div className="font-mono text-sm break-all p-3 rounded-lg border border-gray-200 bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                  {transaction.input || "No input data available"}
                </div>
              </div>

              {/* Input Data Type Indication */}
              <div className="mb-4">
                {isContractInteraction(transaction.input) ? (
                  <Badge className="bg-blue-100 text-blue-800 border-blue-200 py-1 px-3">
                    Contract Interaction
                  </Badge>
                ) : (
                  <Badge className="bg-gray-100 text-gray-800 border-gray-200 py-1 px-3">
                    Simple Transfer
                  </Badge>
                )}
              </div>

              {/* Decoded Parameters Section (placeholder) */}
              {isContractInteraction(transaction.input) && (
                <div className="mt-6">
                  <div className="flex items-center mb-3">
                    <div className="text-sm font-medium text-gray-700">
                  ...
                  <Card className="border border-gray-200 shadow-sm rounded-lg">
                    <CardContent className="p-4">
                      <div className="text-gray-500 text-sm">
                        The transaction contains complex input data that would
                        require a decoder to interpret. View on Etherscan for
                        more details about this contract interaction.
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
                      ...
                      >
                        ...
                        View Decoded Data on Etherscan
                      </Button>
                    </CardContent>
                  </Card>
                </div>
