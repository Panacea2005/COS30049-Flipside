...
const getTransactionTypeColor = (
  ...
  if (currentAddress) {
    const isOutgoing =
      transaction.fromAddress.toLowerCase() === currentAddress.toLowerCase();
    const isIncoming =
      transaction.toAddress.toLowerCase() === currentAddress.toLowerCase();
...
export const VisualizationPage = () => {
  ...
  useEffect(() => {
    async function fetchTransactions() {
      ...
      try {
        ...
        const neo4jTransactions = await neo4jClient.getTransactionsForAddress(
          searchedAddress
        );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <h1 className="text-3xl font-semibold leading-tight tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-sky-800">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="w-full lg:w-5/12 bg-white rounded-lg shadow-sm overflow-hidden">
                <div className="p-6">
                  ...
                  <div className="h-[600px]">
                    {" "}
                    {/* Fixed height for transactions container */}
